...
#include "src/KMeans.h"				// kmeans includes
#include "src/KMdata.h"				// data points
#include "src/KMfilterCenters.h"			// centers
#include "src/KMterm.h"				// termination conditions
#include "src/KMrand.h"				// random number generation
